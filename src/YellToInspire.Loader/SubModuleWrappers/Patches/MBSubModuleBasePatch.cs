...
namespace YellToInspire.Loader.SubModuleWrappers.Patches
{
    /// <summary>
    /// Patches <see cref="MBSubModuleBase.OnMissionBehaviourInitialize(Mission)"/> so that it calls <see cref="MBSubModuleBaseListWrapper.OnMissionBehaviorInitialize(Mission)"/>
    /// </summary>
